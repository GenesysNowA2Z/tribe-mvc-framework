            ...
            <div class="row justify-content-center w-100">
                <div class="col-lg-4">
                    <div class="text-center">
                        <img src="<?php echo url(); ?>/resources/images/backgrounds/404.svg"
                             alt="adminpro-img"
                             class="img-fluid"
                             width="500">
                        <h1 class="fw-bold mb-7 fs-9">404 ERROR</h1>
                        <h4 class="fw-semibold mb-7">This page you are looking for could not be found.</h4>
                        <a class="btn btn-primary" href="<?php echo url(); ?>" role="button">Go Back to Home</a>
                    </div>
                </div>
            </div>
        </div>
